...
class DestinasiModel {
  ...
  List<AllDestinasi> wisataGunung;
  List<AllDestinasi> wisataDanau;
  List<AllDestinasi> wisataPantai;
  List<AllDestinasi> wisataCandi;
  ...
  factory DestinasiModel.fromJson(Map<String, dynamic> json) => DestinasiModel(
        ...
        wisataGunung: List<AllDestinasi>.from(
            json["wisata_gunung"].map((x) => AllDestinasi.fromJson(x))),
        wisataDanau: List<AllDestinasi>.from(
            json["wisata_danau"].map((x) => AllDestinasi.fromJson(x))),
        wisataPantai: List<AllDestinasi>.from(
            json["wisata_pantai"].map((x) => AllDestinasi.fromJson(x))),
        wisataCandi: List<AllDestinasi>.from(
            json["wisata_candi"].map((x) => AllDestinasi.fromJson(x))),
      );
